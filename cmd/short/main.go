...
<body style="font-family:monospace;background:#111;color:#eee;">
	<div style="margin-bottom:10px;">
		<a href="http://34.57.124.217:8080/?symbol=%s&tf=%s" style="color:#7fffd4;">🟢 Long Scanner</a> |
		<a href="http://34.57.124.217:8081/?symbol=%s&tf=%s" style="color:#ff7f7f;">🔴 Short Scanner</a>
		&nbsp;&nbsp;|&nbsp;&nbsp;
