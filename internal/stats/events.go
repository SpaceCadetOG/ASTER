...
type Event struct {
	...
	CacheCandleHits   int64     `json:"cache_candle_hits,omitempty"`
	CacheCandleMisses int64     `json:"cache_candle_misses,omitempty"`
	CacheMicroHits    int64     `json:"cache_micro_hits,omitempty"`
	CacheMicroMisses  int64     `json:"cache_micro_misses,omitempty"`
	CacheEMAHits      int64     `json:"cache_ema_hits,omitempty"`
	CacheEMAMisses    int64     `json:"cache_ema_misses,omitempty"`
