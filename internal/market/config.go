...
type RankConfig struct {
	...
	StaleBookSec        float64
	StaleOISec          float64
	StaleFundingSec     float64
...
func loadRankConfigFromEnv() RankConfig {
	return RankConfig{
		...
		StaleTickerSec:      envFloat("RANK_STALE_TICKER_SEC", 90),
		StaleBookSec:        envFloat("RANK_STALE_BOOK_SEC", 30),
		StaleOISec:          envFloat("RANK_STALE_OI_SEC", 180),
		StaleFundingSec:     envFloat("RANK_STALE_FUNDING_SEC", 300),
