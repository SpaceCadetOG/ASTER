...
go build -o /opt/aster/bin/live ./cmd/live
chmod +x /opt/aster/bin/whale /opt/aster/bin/liqs /opt/aster/bin/oflow /opt/aster/bin/tape /opt/aster/bin/live
...
cp systemd/env/live.env.example /opt/aster/env/live.env
```
